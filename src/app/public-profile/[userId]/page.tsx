    ...
    if (!session) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50">
                <p className="text-gray-600 mb-4 text-center text-base sm:text-lg">You need to be signed in to view public profiles.</p>
                <Button
        ...
        <div className="flex flex-col items-center bg-gray-50 px-4 sm:px-6 py-8 min-h-screen">
            <Card className="w-full max-w-2xl bg-white shadow-xl rounded-2xl">
                ...
                <CardContent className="p-4 sm:p-6">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-4 text-center">Achievements & Badges</h3>
                    ...
                    <div className="text-center mt-8">
                        <h4 className="text-base sm:text-lg font-semibold text-gray-700 mb-2">Share this Profile</h4>
...
function BadgeIcon({ level, prefix }: { level: number; prefix: string }) {
    return (
        <div className="text-center hover:scale-105 transition-transform">
            ...
            />
            <p className="text-xs sm:text-sm text-gray-600 mt-1 capitalize">{prefix} level {level}</p>
        </div>
    );
}
            ...
            <div className="flex flex-wrap justify-center gap-4">
                {badges.map(b => (
                    <div key={b.badge} className="text-center hover:scale-105 transition-transform">
                        ...
                        />
                        <p className="text-[11px] sm:text-xs text-gray-500 italic mt-1">🎯 {b.required}+ {title.split(" ")[0].toLowerCase()}</p>
                    </div>
                ))}
            </div>
        </div>
