...
const auctionBadges: BadgeInfo[] = [
  { title: "First Hammer", image: "auction1", requirement: 1, tooltip: "Create your first auction", description: "You're officially a seller now!" },
  { title: "Stack Starter", image: "auction2", requirement: 5, tooltip: "Create 5 auctions", description: "You're warming up!" },
  { title: "Verified Seller", image: "auction3", requirement: 25, tooltip: "Create 25 auctions", description: "People trust your listings." },
  { title: "Auction Kingpin", image: "auction4", requirement: 50, tooltip: "Create 50 auctions", description: "You run the show!" },
  { title: "Listing Pro", image: "auction5", requirement: 100, tooltip: "Create 100 auctions", description: "You're a seasoned auctioneer!" }
];

const winBadges: BadgeInfo[] = [
  { title: "Victory Flag", image: "win1", requirement: 1, tooltip: "Win your first auction", description: "First win always feels sweet." },
  { title: "Lucky Charmo", image: "win2", requirement: 5, tooltip: "Win 5 auctions", description: "You're getting the hang of it!" },
  { title: "Golden Medalist", image: "win3", requirement: 10, tooltip: "Win 10 auctions", description: "You've struck gold!" },
  { title: "Last Second Sniper", image: "win4", requirement: 25, tooltip: "Win 25 auctions", description: "That clutch timing is deadly." },
  { title: "Trophy Champion", image: "win5", requirement: 50, tooltip: "Win 50 auctions", description: "You’re a true champion!" }
];

const bidBadges: BadgeInfo[] = [
  { title: "Bid Beginner", image: "bid1", requirement: 1, tooltip: "Place your first bid", description: "Your bidding journey begins." },
  { title: "Loop Biddero", image: "bid2", requirement: 10, tooltip: "Place 10 bids", description: "Getting in the rhythm!" },
  { title: "Precision Bidder", image: "bid3", requirement: 50, tooltip: "Place 50 bids", description: "You know when to strike." },
  { title: "Quick Bidder", image: "bid4", requirement: 100, tooltip: "Place 100 bids", description: "Fast and fearless." },
  { title: "Bidding Beast", image: "bid5", requirement: 500, tooltip: "Place 500 bids", description: "You’re dominating the battlefield!" }
];

const enhancedDescriptions = new Map<string, string>([
  ["You're officially a seller now!", "You’ve taken the first big step. Welcome to the seller's arena!"],
...
const BadgeSection: React.FC<BadgeSectionProps> = ({ title, Icon, current, thresholds, badges }) => {
  ...
  return (
    <section className="mb-12">
      ...
      <p className="text-sm text-gray-600 mb-2">
        You earned {progress.earned}/{progress.total} badges {progress.next && `(Next at ${progress.next})`}
      </p>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
        {badges.map(badge => (
          ...
          >
            ...
            <p className="text-xs text-gray-600 mt-1 leading-snug">{enhanceDescription(badge.description)}</p>
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Track your badge achievements in auctions, bidding, and winning." />
        <meta property="og:title" content="Badge Progress" />
        <meta property="og:description" content="Gamify your auction experience and collect badges as you go!" />
      </Head>
        ...
        <Card className="max-w-5xl mx-auto">
          <CardHeader>
            ...
            <p className="text-center text-gray-600 max-w-xl mx-auto text-sm">
              Understand how to earn badges and track your journey, even if you&apos;re just browsing.
            </p>
          </CardHeader>
          <CardContent>
            {loading ? (
