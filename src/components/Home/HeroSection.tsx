...
export const HeroSection = ({ session }: { session: any }) => {
  const textVariants = {
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl mx-auto z-10">
        ...
        <div className="w-full md:w-1/2 text-white text-center md:text-left">
          ...
          >
            {session ? (
              <>
                <Button className="bg-emerald-800 text-base p-2 sm:p-4">Start Bidding</Button>
                <Button
                  variant="outline"
              ...
              <>
                <Link href="/sign-in">
                  <Button className="bg-white text-emerald-700">Login to Bid</Button>
                </Link>
                <Link href="/sign-up">
